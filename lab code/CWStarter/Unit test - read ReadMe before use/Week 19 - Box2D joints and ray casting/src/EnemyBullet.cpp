...
EnemyBullet::EnemyBullet(b2World * world, sf::Vector2f position, sf::Vector2f size, sf::Texture* texture, const float orientation, CollisionFilter type)
{
	m_delete = false;
	b2BodyDef l_bodyDef;
	...
	l_fixtureDef.filter.maskBits = PhysicalThing::GREENBOX | PhysicalThing::PLAYER;//PhysicalThing::
...
void EnemyBullet::SetRotation(float rotation)
{
	this->rotation = rotation;
}
void EnemyBullet::onAction() {
	m_delete = true;
}
